Shader "CustomSprites/UIFillShape"
{
    Properties
    {
        [Header(Shape)]
        ...
        _MoveSpeed("Move Speed X,Y", Vector) = (1,-1,0,0)
        ...
        _SparkleMoveSpeed("Sparkle MoveSpeed X,Y", Vector) = (1,1,0,0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 _Color;
            float _Speed;
            float2 _MoveSpeed, _SparkleMoveSpeed;
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float2 sparkleMoveSpeed = _Time.x * _SparkleMoveSpeed;
                float2 sparkUV = Unity_Spherize_float(i.uv_MainTex,float2(0.5,0.5),_Distort, moveSpeed,shapeMask);
                float2 sparkUV2 = Unity_Spherize_float(i.uv_MainTex, float2(0.5,0.5),_Distort,sparkleMoveSpeed,shapeMask);
